 ...
 *
 * Additional data:
 * - NEW_YEAR_OFFSETS: Days from Jan 1 to Lunar New Year for each year
 *
 ...
 * Index 0 = year 1900
 */
export const NEW_YEAR_OFFSETS: number[] = [
...
/**
 * Julian Day Number for January 1, 1900
 */
export const JULIAN_1900_JAN_1 = 2415021;

/**
 * Get number of days in a lunar month
 * @param yearInfo - Lunar info for the year
 * @param month - Month number (1-12)
 * @returns 29 or 30
 */
export function getLunarMonthDays(yearInfo: number, month: number): number {
 ...
 * @param yearInfo - Lunar info for the year
 * @returns Leap month number (1-12) or 0
 */
export function getLeapMonth(yearInfo: number): number {
  return yearInfo & 0xf;
}
 ...
 * @param yearInfo - Lunar info for the year
 * @returns 29 or 30, or 0 if no leap month
 */
export function getLeapMonthDays(yearInfo: number): number {
  if (getLeapMonth(yearInfo) === 0) return 0;
  return (yearInfo >> 16) & 1 ? 30 : 29;
}

/**
 * Get total days in a lunar year
 * @param yearInfo - Lunar info for the year
 * @returns Total days (353-385)
 */
export function getLunarYearDays(yearInfo: number): number {
  let days = 0;
  for (let i = 1; i <= 12; i++) {
